...
namespace DE.Shared
{
	public class AssetDataViewModel
	{
        ...
        public StoredFileDataViewModel? Picure { get; set; } = new StoredFileDataViewModel();

        public List<StoredFileDataViewModel>? Decuments { get; set; } = new List<StoredFileDataViewModel>();
    }
}
